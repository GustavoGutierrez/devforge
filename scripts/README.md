...
```bash
bash scripts/package_release_bundle.sh --version 1.1.6 --target-os linux --target-arch amd64
bash scripts/package_release_bundle.sh --version 1.1.6 --target-os darwin --target-arch arm64
```
