...
```bash
bash scripts/package_release_bundle.sh --version 2.1.2 --target-os linux --target-arch amd64
bash scripts/package_release_bundle.sh --version 2.1.2 --target-os darwin --target-arch arm64
```
